...
class DiseaseAnalyzer:
    ...
    def analyze_grape_image(self, image_data: bytes, mime_type: str) -> tuple[Optional[dict], Optional[str]]:
        ...
        json_example = {
            ...
            "possible_causes": "Fungus (Erysiphe necator) exacerbated by high humidity and moderate temperatures.",
            "recommended_actions": "Apply fungicides (e.g., sulfur, myclobutanil), prune affected parts, improve air circulation.",
            "prevention_strategies": "Use resistant varieties, proper spacing, good air circulation, and timely fungicide applications."
        }
        ...
        prompt = (
            ...
            f"Identify the disease, provide a confidence score (0.0 to 1.0), and a brief explanation including symptoms, possible causes, "
            f"recommended actions/treatments, and prevention strategies. "
            ...
            f"Fields: 'disease_detected', 'confidence_score', 'explanation', 'symptoms', 'possible_causes', 'recommended_actions', 'prevention_strategies'."
            f"Example: {json_example_str}"
            f"Eğer hastalık tespit edilmezse, 'disease_detected' alanını 'Sağlıklı', 'confidence_score' alanını 1.0 ve 'explanation', 'symptoms', 'possible_causes', 'recommended_actions', 'prevention_strategies' alanlarını 'Hastalık belirtisi tespit edilmedi.' olarak ayarlayın. "

            ...
            with st.spinner("Görüntü analiz ediliyor..."):
                try:
                    ...
                    new_analysis = Analysis(
                        ...
                        analysis_date=datetime.now(), # Set the analysis date
                        gemini_response=raw_gemini_analysis_response,
                        explanation=analysis_result.get('explanation', None), # New/Updated field
                        symptoms=analysis_result.get('symptoms', None), # New field
                        possible_causes=analysis_result.get('possible_causes', None),
                        recommended_actions=analysis_result.get('recommended_actions', None), # New/Updated field
                        prevention_strategies=analysis_result.get('prevention_strategies', None) # New field
                    )
